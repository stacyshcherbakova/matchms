...
## unpublished
### Changed
- `BlinkCosine` now computes and returns scores as `np.float64` by default, consistent with the other similarity scores. The new `dtype` parameter can be set to `np.float32` to reduce memory usage [#880](https://github.com/matchms/matchms/issues/880).
